...
public class GetProductByIdUseCase(
    ...
    public async Task<ResponseGetProductByIdJson> Execute(Guid id) {
        var productEntity = await _productReadOnlyRepository.GetById(id)
        ...
        var formattedActualPriceHistory = _mapper.Map<ResponseGetProductPriceByIdJson>(actualPriceHistory);
